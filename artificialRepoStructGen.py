...
while True:
    ...
    if not os.path.exists(x):
        ...
        print("Root selected")
        break
for i in range(10000): #change this number to change how much gets generated. 
    ...
    path = os.path.join(x,"/".join(stringedhash[i:i+2] for i in range(0,14,2)),stringedhash,(stringedhash+".pdf")) #create path
